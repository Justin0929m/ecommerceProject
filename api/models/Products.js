...
class Products {
  ...
  static async fetchProducts() {
    try {
      const query = `SELECT prodID, prodName, prodDesc, amount, quantity FROM Products`;
  ...
  static async fetchProduct(prodID) {
    try {
      const query = `SELECT prodID, prodName, prodDesc, amount, quantity FROM Products WHERE prodID = ?`;
